...
- Prefer an approved spec created by the local `.claude/skills/brainstorming` skill.
...
2. Use the local `.claude/skills/writing-plans` skill.
...
5. After plan approval, hand off to `.claude/commands/subagent-development.md`.
