 ...
 */
final class Version20250904142938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (game_id INT AUTO_INCREMENT NOT NULL, type INT NOT NULL, winner VARCHAR(255) DEFAULT NULL, date DATE NOT NULL, status TINYINT(1) NOT NULL, round INT NOT NULL, PRIMARY KEY(game_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE player (player_id INT AUTO_INCREMENT NOT NULL, player_name VARCHAR(255) NOT NULL, PRIMARY KEY(player_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
